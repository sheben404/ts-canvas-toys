...
})({"k1NpG":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "69f74e7f31319ffd";
module.bundle.HMR_BUNDLE_ID = "5028c0b26b193967";
"use strict";
...
},{}],"3VM0C":[function(require,module,exports) {
...
let canvasPen = {
    ...
    lineFn: function(e) {
        ...
        if (canvasPen.imageData != null) drawCtx.putImageData(canvasPen.imageData, 0, 0, 0, 0, drawCanvas.offsetWidth, drawCanvas.offsetHeight);
        drawCtx.lineTo(x, y);
    ...
    rectFn: function(e) {
        ...
        drawCtx.beginPath();
        drawCtx.lineWidth = canvasPen.lineWidth;
        drawCtx.rect(canvasPen.beginX, canvasPen.beginY, x - canvasPen.beginX, y - canvasPen.beginY);
        drawCtx.strokeStyle = canvasPen.color;
        drawCtx.stroke();
        drawCtx.closePath();
    },
    arcFn: function(e) {
        ...
        drawCtx.beginPath();
        drawCtx.lineWidth = canvasPen.lineWidth;
        drawCtx.arc(canvasPen.beginX, canvasPen.beginY, Math.abs(e.clientX - canvasPen.beginX), 0, 2 * Math.PI);
        drawCtx.strokeStyle = canvasPen.color;
        drawCtx.stroke();
        drawCtx.closePath();
    },
...
const eraBtn = document.querySelector(".era");
...
const lineDivs = document.querySelectorAll(".width");
...
drawCanvas.onmouseup = function() {
    canvasPen.imageData = drawCtx.getImageData(0, 0, drawCanvas.offsetWidth, drawCanvas.offsetHeight);
    canvasPen.isDraw = false;
    if (canvasPen.type === "line") drawCtx.closePath();
};
...
clearBtn.onclick = function() {
    ...
    drawCtx.clearRect(0, 0, Number(drawCanvas.getAttribute("width")), Number(drawCanvas.getAttribute("height")));
};
...
},{}]},["k1NpG","3VM0C"], "3VM0C", "parcelRequirea7fe")

//# sourceMappingURL=index.6b193967.js.map
